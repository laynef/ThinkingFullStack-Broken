...
import { data } from '../data/backendCachingData';


export default class BackendCachingPage extends Component {

	render() {
		return (
			<div id="BackendCachingPage" className="card">
				{data.title &&
				...
				{data.application &&
					<div className="definition-wrapper">
						...
						<div className="definition-wrapper">
							<h2 className="fjc">Welcome to Back End Caching! Happy Coding!</h2>
						</div>
					</div>}
			</div>
		);
