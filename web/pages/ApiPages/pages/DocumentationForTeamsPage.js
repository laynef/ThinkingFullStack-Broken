...
import { data } from '../data/documentationForTeamsData';


export default class DocumentationForTeamPage extends Component {

	render() {
		return (
			<div id="DocumentationForTeamPage" className="card">
				{data.title &&
				...
				{data.application &&
					<div className="definition-wrapper">
						...
						{data.application.examples && data.application.examples.map((e, i) => (
						...
						<div className="definition-wrapper">
							<h3>Check Out: <a href="https://github.com/swagger-api/swagger-node">Swagger Express.js</a></h3>
						</div>
						<div className="definition-wrapper">
							<h2 className="fjc">Welcome to API Documentation! Happy Coding!</h2>
						</div>
					</div>}
			</div>
		);
