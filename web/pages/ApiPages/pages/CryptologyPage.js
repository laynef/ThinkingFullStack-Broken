...
import { data } from '../data/cryptologyData';


export default class CryptologyPage extends Component {

	render() {
		return (
			<div id="CryptologyPage" className="card">
				{data.title &&
				...
				{data.application &&
					<div className="definition-wrapper">
						...
						<div className="definition-wrapper">
							<h2 className="fjc">Welcome to Cryptology! Happy Coding!</h2>
						</div>
					</div>}
			</div>
		);
