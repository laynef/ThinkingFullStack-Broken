...
import { data } from '../data/errorHandlingData';


export default class ErrorHandlingPage extends Component {

	render() {
		return (
			<div id="ErrorHandlingPage" className="card">
				{data.title &&
				...
				{data.application &&
					<div className="definition-wrapper">
						...
						<div className="definition-wrapper">
							<h2 className="fjc">Welcome to Proper Error Handling! Happy Coding!</h2>
						</div>
					</div>}
			</div>
		);
