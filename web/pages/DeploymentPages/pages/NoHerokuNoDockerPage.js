...
import { data } from '../data/noHerokuNoDockerData';


export default class NoHerokuNoDockerPage extends Component {

	render() {
		return (
			<div id="NoHerokuNoDockerPage" className="card">
				{data.title &&
				...
				{data.application &&
					<div className="definition-wrapper">
						...
						<div className="definition-wrapper">
							<h2 className="fjc">{data.ending}</h2>
						</div>
					</div>}
			</div>
		);
