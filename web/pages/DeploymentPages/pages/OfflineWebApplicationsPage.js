...
import { data } from '../data/offlineWebApplicationsData';


export default class OfflineWebApplicationPage extends Component {

	render() {
		return (
			<div id="OfflineWebApplicationPage" className="card">
				{data.title &&
