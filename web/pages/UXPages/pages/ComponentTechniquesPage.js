...
import { data } from '../data/componentTechniquesData';


export default class ComponentTechniquesPage extends Component {

	render() {
		return (
			<div id="ComponentTechniquesPage" className="card">
				{data.title &&
