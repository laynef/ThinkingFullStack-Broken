...
import { data } from '../data/CleanCodeTechniquesData';


export default class CleanCodeTechniquesPage extends Component {

	render() {
		return (
			<div id="CleanCodeTechniquesPage" className="card">
				{data.title &&
