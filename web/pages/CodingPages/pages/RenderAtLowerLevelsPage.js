...
import { data } from '../data/RenderAtLowerLevelsData';


export default class RenderAtLowerLevelsPage extends Component {

	render() {
		return (
			<div id="RenderAtLowerLevelsPage" className="card">
				{data.title &&
