...
import { data } from '../data/ProactiveProgrammingData';


export default class ProactiveProgrammingPage extends Component {

	render() {
		return (
			<div id="ProactiveProgrammingPage" className="card">
				{data.title &&
