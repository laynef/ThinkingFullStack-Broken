...
import { data } from '../data/EnterpriseEnvironmentsData';


export default class EnterpriseEnvironmentsPage extends Component {

	render() {
		return (
			<div id="EnterpriseEnvironmentsPage" className="card">
				{data.title &&
